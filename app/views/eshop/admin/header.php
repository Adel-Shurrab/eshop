...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= ASSETS . THEME ?>/admin/users.css">
    ...
    <section id="container">
        ...
        *********************************************************************************************************************************************************** -->
        ...
        <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?= BASE_URL ?>admin" class="logo"><b><?= WEBSITE_TITLE ?> | <?= $data['page_title'] ?></b></a>
            <!--logo end-->
            ...
            <?php if (isset($data['user_data'])): ?>
                <div class="top-menu">
                    <ul class="nav pull-right top-menu">
                        <li><a class="logout" href="<?= BASE_URL ?>">Website</a></li>
